...
This book contains a lot of tables. Please check whether table layout is clear. The positioning of tables on the page will still change, so there is no need to signal unfortunate page breaks. 
Please also have a look at the list of references, in particular missing capitalization.
